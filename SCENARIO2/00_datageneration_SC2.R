...
shape.y0d <- alpha.y0d <- 1.6

mean.y1nd <- 11 #time to primary event, average
mean.y0nd <- 4 #time to primary event, average

mean.y1d <- 7 #time to primary event, average
mean.y0d <- 7 #time to primary event, average
...
jpeg("KM_ND_SC2.jpeg",width = 6000, height = 5000, units="px", res=1200)
...
jpeg("KM_D_SC2.jpeg",width = 6000, height = 5000, units="px", res=1200)
...
jpeg("KM_obs_SC2.jpeg",width = 5000, height = 5000, units="px", res=1200)
...
save(thetatrue, file = paste("thetatrue2_",seed,".RData",sep=""))
rm(theta)
