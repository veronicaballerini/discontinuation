...
jpeg(paste(wd,"/SCENARIO2/ACE_d.jpeg",sep=""),width = 5000, height = 2500, units="px", res=1200)
...
jpeg(paste(wd,"/SCENARIO2/DCE_ND.jpeg",sep=""),width=5000,height = 2500,units="px",res=1200)
...
jpeg(paste(wd,"/SCENARIO2/DCE_d.jpeg",sep=""),width=5000,height = 2500,units="px",res=1200)
