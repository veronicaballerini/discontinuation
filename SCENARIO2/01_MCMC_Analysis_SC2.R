...
source(paste(wd,"/SCENARIO1/MCMC.R",sep=""))
source(paste(wd,"/SCENARIO1/CompleteLogPost.R",sep=""))
source(paste(wd,"/SCENARIO1/DataAugmentation.R",sep=""))
...
#### Load data
observed.data<- read.table(paste(wd,"/SCENARIO2/","simdata2_4800.txt",sep=""),header=T)
...
par.start <- list(mu.0 = m.start, sigma.0 = sd.start,
                  ...
                  mu.d3 = m.start, sigma.d3 = sd.start,
                  ...
                  mu.y3 = m.start, sigma.y3 = sd.start,
...
proposal <- list(sd.0 = 0.3, sd.1 = 0.3, sd.2 = 0.4, sd.3 = 0.7,
                 ...
                 sd.y1 = 0.15, sd.y2 = 0.2, sd.y3 = 0.3,
                 sd.lambda = 0.2)
...
save.image(paste(wd,"/SCENARIO2/",string1,string2,"_",string3,"-",
                 string4,"SC2.RData",sep=""))
