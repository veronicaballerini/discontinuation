da.discontinuation <- function(theta, theta.prior, observed.data, ID.old, D.old) {
    ...
    num <- theta$pi[id1 == 1] * Sweib(Y[id1 == 1], theta$alpha.y1nd, theta$beta.y1nd + theta$eta.y1 * x1[id1 == 1] + theta$eta.y2 * x2[id1 == 1] + theta$eta.y3 *
        x3[id1 == 1])
    den <- num + (1 - theta$pi[id1 == 1]) * Sweib(Dobs[id1 == 1], theta$alpha.d, theta$beta.d + theta$eta.d1 * x1[id1 == 1] + theta$eta.d2 * x2[id1 == 1] + theta$eta.d3 *
        x3[id1 == 1])
    ...
    dii <- rweibull(sum(ii == 1), shape = theta$alpha.d, scale = exp(-(theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 * x3[ii ==
        1])/theta$alpha.d))
    ...
    D.c[ii == 1] <- rweibull(sum(ii), shape = theta$alpha.d, scale = exp(-(theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 *
        x3[ii == 1])/theta$alpha.d))
    ...
    rr <- exp(logpost.i(theta, theta.prior, complete.data.c) - logpost.i(theta, theta.prior, complete.data.old))
    ratio <- rep(0, n)
    ...
    ratio[ii == 1] <- rr[ii == 1] * {
        theta$pi[ii == 1]/{
            (1 - theta$pi[ii == 1]) * dweib(D.c[ii == 1], theta$alpha.d, theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 *
                x3[ii == 1])
        }
    }
    ...
    ratio[ii == 1] <- rr[ii == 1] * {
        {
            (1 - theta$pi[ii == 1]) * dweib(D.old[ii == 1], theta$alpha.d, theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 *
                x3[ii == 1])
        }/theta$pi[ii == 1]
    }
    ...
    ratio[ii == 1] <- rr[ii == 1] * {
        dweib(D.old[ii == 1], theta$alpha.d, theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 * x3[ii == 1])/dweib(D.c[ii ==
            1], theta$alpha.d, theta$beta.d + theta$eta.d1 * x1[ii == 1] + theta$eta.d2 * x2[ii == 1] + theta$eta.d3 * x3[ii == 1])
    }
