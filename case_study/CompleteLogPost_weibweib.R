logpost_weibweib<-function(theta, theta.prior, complete.data){
...
logpost.i_weibweib <-function(theta, theta.prior, complete.data){
  ...
  logprior <- logprior + 
    dgamma(theta$alpha.d,
           shape=theta.prior$a.d,
           scale=theta.prior$b.d, log=TRUE) +
    # log(dtgamma(theta$alpha.d, 
    #        shape=theta.prior$a.d, 
    #        a=1,
    #        scale=theta.prior$b.d)) +
