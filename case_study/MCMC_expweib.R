mcmc.tdiscontinue_expweib <- function(niter, burn,
    ...
    repeat {
        theta.start <- list(eta.0 = rnorm(1, mean = par.start$mu.0,
            ...
            eta.d3 = rnorm(1, mean = par.start$mu.d3,
                sd = par.start$sigma.d3), alpha.y1nd = par.start$shape.y1nd *
        ...
        theta <- list(eta.0 = theta.start$eta.0,
            ...
            eta.d3 = theta.start$eta.d3, alpha.y1nd = theta.start$alpha.y1nd,
        ...
        for (j in 1:niter) {
            ...
            discontinuedata <- da.discontinuation_expweib(theta,
            ...
            log.post.eta.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.eta.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.beta.d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.beta.d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.eta.d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.eta.d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.alpha.y1nd.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.alpha.y1nd.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.beta.y1nd.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.beta.y1nd.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.alpha.y1d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.alpha.y1d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.beta.y1d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.beta.y1d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.alpha.y0nd.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.alpha.y0nd.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.beta.y0nd.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.beta.y0nd.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.alpha.y0d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.alpha.y0d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.beta.y0d.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.beta.y0d.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.eta.y.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.eta.y.old <- logpost_expweib(theta,
                theta.prior, complete.data)
            ...
            log.post.delta.c <- logpost_expweib(thetaprop,
                theta.prior, complete.data)
            log.post.delta.old <- logpost_expweib(theta,
                theta.prior, complete.data)
