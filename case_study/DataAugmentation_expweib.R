da.discontinuation_expweib <-function(theta, 
                             theta.prior, 
                             observed.data, 
                             ID.old, 
                             D.old){
  ...
  rr <- exp(logpost.i_expweib(theta, theta.prior, complete.data.c) - 
              logpost.i_expweib(theta, theta.prior, complete.data.old))
  ratio<-rep(0, n)
